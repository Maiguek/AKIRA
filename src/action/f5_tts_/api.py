...
if __name__ == "__main__":
    f5tts = F5TTS()#ckpt_file="model_1200000.safetensors", vocab_file="/infer/examples/vocab.txt")
...
##    )
    ...
    wav, sr, spect = f5tts.infer(
        ref_file="../refi_audio.wav",
        ref_text="Hello, hello. Nice to meet you!",
        gen_text="""I really like cats. Meow!""",
        file_wave="../output.wav",
        file_spect="../spect.png",
        seed=-1,  # random seed = -1
    )
